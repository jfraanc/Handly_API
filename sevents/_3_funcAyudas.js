 ...
 //Enviar mail confirmation
  function sendMailConfirm(tokenEmail, email) {
    ...
    const mailOptions = {
      ...
      '<HR><h4>Para activar tu cuenta pulsa el logo de Handly</h4><a href="https://handly-api.herokuapp.com/mailcnf/'+tokenEmail+'" class="site-logo visible-mobile"> <img style="with:auto; height:auto; max-width:300px" src="https://res.cloudinary.com/dz0lvutrn/image/upload/v1592736413/app/mailConfirmation/Handly_Logo.png" alt="handly"> </a>'
    };
